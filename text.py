...
HELP_MESSAGE = (
    ...
    "<b>/start</b> - Начать работу с ботом<br>\n"
    "<b>/help</b> - Получить помощь<br>\n"
    "<b>профиль, комару профиль, кпрофиль</b> - Посмотреть свой профиль<br>\n"
    "<b>сменить ник &lt;ник&gt;</b> - Смена ника в профиле<br>\n"
